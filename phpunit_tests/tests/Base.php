...
include_once "../src/Model/AddPostToPageUpdateRequest.php";
include_once '../src/Model/CreateAccountRequest.php';
include_once '../src/Model/ValidateAccountRequest.php';
include_once '../src/Model/ChangePasswordRequest.php';
include_once '../src/Model/RateContentRequest.php';
include_once '../src/Model/AddInterestRequest.php';
